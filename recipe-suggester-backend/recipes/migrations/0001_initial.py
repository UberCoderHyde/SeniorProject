# Generated by Django 5.0.1 on 2025-03-24 01:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, help_text='Measurement unit (e.g., grams, cups, lb, oz)', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=2, help_text='Quantity used in the recipe', max_digits=6)),
